...
//if the input or empty we shall a border of red color to the fields
...
//lets add on event listener to the button 
...
function addFriendToList(e){
  ...
  //  If not empty we are going to add a friend 
    ...
    //Let us clear all the input for another friend maybe
    inputName.value = ''
    inputNumber.value = ''
